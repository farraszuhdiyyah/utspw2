                    ...
                    <div class="card" style="border-radius: 3rem;">
                        <div class="row g-0">
                            <div class="col-md-6 col-lg-5 d-none d-md-block">
                                <img src="assets/img/LOGO.png" alt="login form" 
                                    class="img-fluid" style="border-radius: 3rem 0 0 1rem;" />
                            </div>
                                ...
                                <div class="card-body p-4 p-lg-4 text-black">
                                    ...
                                    <form data-parsley-validate="" novalidate="" onsubmit="return false">
                                        ...
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <span class="h1 fw-bold mb-0">Faras</span>
                                        </div>
                                        ...
                                        <div class="toast-container position-fixed bottom-0 end-0 p-3">
                                            <div id="liveToast" class="toast" role="alert" aria-live="assertive"
                                                ...
                                                <div class="toast-header bg-info">
                                                    ...
                                                    <strong class="me-auto text-black">Admin Farras</strong>
